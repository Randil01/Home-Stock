      ...
      <Row className="w-100 justify-content-center position-relative" style={{ zIndex: 2 }}>
        <Col xs={11} sm={8} md={6} lg={5} xl={4}>
          <div className="text-center mb-4">
            <h1 className="display-4 fw-bold fst-italic text-white mb-4">Welcome to Home Stock</h1>
            <p className="lead text-white fst-italic">Your Personal Home Management Solution</p>
          </div>
